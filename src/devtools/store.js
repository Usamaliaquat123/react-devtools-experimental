    ...
    while (i < operations.length) {
      ...
      switch (operation) {
        case TREE_OPERATION_ADD:
          ...
          break;
        case TREE_OPERATION_CLEAR_CHILDREN: {
          id = ((operations[i + 1]: any): number);
          ...
          let justRemovedIDs = [];
          const recursivelyRemove = id => {
            justRemovedIDs.push(id);
            const el = this._idToElement.get(id);
            if (!el) {
              throw new Error(
                'Store does not contain fiber ' +
                  id +
            ...
            el.children.forEach(recursivelyRemove);
          };
        ...
        default:
          // ----------
          // TODO: I get here with 0 sometimes after toggling suspense :-(
          // ----------
